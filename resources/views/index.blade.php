...
<html lang="en">
    <head>
        ...
        <link href="public/css/templatemo-first-portfolio-style.css" rel="stylesheet">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-7 col-12">
                            <div class="hero-text">
                                <div class="hero-title-wrap d-flex align-items-center mb-4">
                                    <img src="public/images/deryl-mini-picture.png" class="avatar-image avatar-image-large img-fluid" alt="">

                                    <h1 class="hero-title ms-3 mb-0">Deryl Here!</h1>
                                </div>
                        ...
                        <div class="col-lg-5 col-12 position-relative">
                            ...
                            <img src="public/images/happy-deryl.png" class="hero-image img-fluid" alt="">
                        </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12">
                            <img src="public/images/couple-working-from-home-together-sofa.jpg" class="about-image img-fluid" alt="">
                        </div>
                        ...
                        <div class="col-lg-6 col-12 mt-5 mt-lg-0">
                            <div class="about-thumb">
                                ...
                                <div class="section-title-wrap d-flex justify-content-end align-items-center mb-4">
                                    ...
                                    <img src="public/images/deryl-mini-picture.png" class="avatar-image img-fluid" alt="">
                                </div>

                                <h3 class="pt-2 mb-3">a little bit about Deryl</h3>

                                <p>There is a saying "Tak kenal maka tak sayang". (if you don't know, you won't love) Im<a href="https://instagram.com/dryl.sofyan" target="_blank">Deryl Sofyan</a> I am deryl sofyan I have an interest in the field of web developer, Graphic Designer and I am also interested in the world of trade such as F n B or Import-Export.</p>
                            ...
                            <div class="profile-thumb">
                                ...
                                <div class="profile-body">
                                    <p>
                                        ...
                                        <span>Deryl Sofyan</span>
                                    </p>

                                    <p>
                                        <span class="profile-small-title">Birthday</span> 
                                        <span>Feb 20, 2005</span>
                                    </p>

                                    <p>
                                        <span class="profile-small-title">Phone</span> 
                                         <span><a href="tel: 305-240-9671">(+62) 821 2909 0785)</a></span>
                                    </p>

                                    <p>
                                        <span class="profile-small-title">Email</span> 
                                        <span><a href="mailto:hello@josh.design">derylsofyans@gmail.com</a></span>
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-2 col-4 ms-auto clients-item-height">
                            <img src="public/images/clients/cachet.svg" class="clients-image img-fluid" alt="">
                        </div>

                        <div class="col-lg-2 col-4 clients-item-height">
                            <img src="public/images/clients/guitar-center.svg" class="clients-image img-fluid" alt="">
                        </div>

                        <div class="col-lg-2 col-4 clients-item-height">
                            <img src="public/images/clients/tokico.svg" class="clients-image img-fluid" alt="">
                        </div>

                        <div class="col-lg-2 col-4 clients-item-height">
                            <img src="public/images/clients/shopify.svg" class="clients-image img-fluid" alt="">
                        </div>

                        <div class="col-lg-2 col-4 me-auto clients-item-height">
                            <img src="public/images/clients/profil-rejser.svg" class="clients-image img-fluid" alt="">
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-8 col-12 ms-auto">
                            <div class="section-title-wrap d-flex justify-content-center align-items-center mb-4">
                                <img src="public/images/white-desk-work-study-aesthetics.jpg" class="avatar-image img-fluid" alt="">
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="projects-thumb">
                                ...
                                <a href="public/images/projects/nikhil-KO4io-eCAXA-unsplash.jpg" class="popup-image">
                                    <img src="public/images/projects/nikhil-KO4io-eCAXA-unsplash.jpg" class="projects-image img-fluid" alt="">
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="projects-thumb">
                                ...
                                <a href="public/images/projects/the-5th-IQYR7N67dhM-unsplash.jpg" class="popup-image">
                                    <img src="public/images/projects/the-5th-IQYR7N67dhM-unsplash.jpg" class="projects-image img-fluid" alt="">
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="projects-thumb">
                                ...
                                <a href="public/images/projects/true-agency-9Bjog5FZ-oc-unsplash.jpg" class="popup-image">
                                    <img src="public/images/projects/true-agency-9Bjog5FZ-oc-unsplash.jpg" class="projects-image img-fluid" alt="">
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-8 col-12">
                                <div class="section-title-wrap d-flex justify-content-center align-items-center mb-5">
                                    <img src="public/images/aerial-view-man-using-computer-laptop-wooden-table.jpg" class="avatar-image img-fluid" alt="">
